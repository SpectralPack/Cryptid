	...
	descriptions = {
		...
		Joker = {
			...
			j_cry_mprime = {
				name = "拾参",
				text = {
					"ラウンド終了時 {C:legendary}M ジョーカー{}を作成する",
		...
		Tag = {
			...
			tag_cry_bundle = {
				name = "バンドルタグ",
				text = {
					"{C:attentionスタンダードタグ{}、{C:tarot}チャームタグ{}、",
			...
			tag_cry_cat = {
				name = "キャットタグ",
				text = { "にゃ～", "{C:inactive}レベル {C:dark_edition}#1#" },
			},
			tag_cry_console = {
				name = "端末タグ",
				text = {
					"無料の",
					"{C:cry_code}プログラムパック{}を与える",
				},
			},
			tag_cry_double_m = {
				name = "ダブルM タグ",
