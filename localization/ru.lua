...
return {
	descriptions = {
		...
		Back = {
			...
			b_cry_redeemed = {
				name = "Искуплённая колода",
				text = {
					"Когда {C:attention}Ваучер{} куплен,",
					"получаешь его {C:attention}доп. уровни",
				},
				unlock = {
					"Откройте все",
					"{C:attention}Ваучеры",
			...
			b_cry_spooky = {
				name = "Жуткая колода",
				text = {
					"В начале забега получите",
					"случайный {C:attention}Джокер{} или {C:cry_candy}Конфету",
				},
				unlock = {
		...
		Blind = {
			...
			bl_cry_clock = {
				...
				text = {
					...
					"12 секунд в этом анте,",
					"умножается на скорость игры",
				},
			},
			bl_cry_hammer = {
				name = "Молоток",
			...
			bl_cry_joke = {
				name = "Шутка",
				text = {
					"Если очки более чем в 2 раза",
					"больше минимума, установить анте на #2#",
				},
			},
			bl_cry_magic = {
				name = "Магия",
			...
			bl_cry_pinkbow = {
				name = "Бантик",
				text = { "Случайный ранг картам", "в руке при игре" },
			},
			bl_cry_sapphire_stamp = {
				name = "Сапфировый штамп",
				text = {
					"Выбор дополнительной карты,",
					"случайная карта отменяется перед подсчётом",
				},
			},
			bl_cry_shackle = {
				name = "Кандалы",
			...
			bl_cry_tax = {
				name = "Налог",
				text = { "Очки за руку ограничены", "до #1#" },
			},
			bl_cry_tornado = {
			...
			bl_cry_trick = {
				...
				text = {
					...
					"все открытые карты в руке рубашкой вверх",
				},
			},
			...
			bl_cry_greed = {
				name = "Жадность",
				text = {
					"+#2# требования блайнда",
					"за каждые $#1# когда выбран",
				},
			},
			bl_cry_decision = {
				name = "Решение",
			...
			bl_cry_chromatic = {
				name = "Хроматический",
				text = {
					"Счёт нечётных по счёту рук вычитается",
				},
			},
			bl_cry_landlord = {
				name = "Помещик",
		...
		Code = {
			...
			c_cry_class = {
				name = "://CLASS",
				text = {
					"Конвертировать {C:cry_code}#1#{} выбранную карт#<у,ы>1#",
			...
			c_cry_delete = {
				...
				text = {
					...
					"предмет больше не появится в этом забеге",
				},
			},
			c_cry_divide = {
				name = "://DIVIDE",
			...
			c_cry_exploit = {
				name = "://EXPLOIT",
				text = {
					"{C:cry_code}Выберите{} {C:cry_code}текущую видимую{} покерную руку,",
					"следующая рука {C:cry_code}считается{} этой рукой",
					"и получает {C:cry_code}+1{} вр. {C:cry_code}Силу Вознесения{}",
				},
			},
			c_cry_global = {
				name = "://GLOBAL",
			...
			c_cry_hook = {
				name = "HOOK://",
				text = {
					"Применить {C:cry_code}Зацеплено{} к",
					"2 выбранным Джокерам",
				},
			},
			c_cry_inst = {
				name = "://INSTANTIATE",
			...
			c_cry_merge = {
				name = "://MERGE",
				text = {
					"Соединить {C:cry_code}выбранный Расходник",
			...
			c_cry_oboe = {
				...
				text = {
					...
					"{C:cry_code}#1#{} дополнительную карт#<у,ы>1# и",
					"{C:cry_code}#1#{} дополнительный выбор#<,а>1#",
			...
			c_cry_seed = {
				...
				text = {
					"Выбери джокера",
					"или игровую карту",
					"чтобы они стали {C:cry_code}Подкрученными",
				},
			},
			c_cry_semicolon = {
				name = ";//",
			...
			c_cry_quantify = {
				name = "://QUANTIFY",
				text = {
					"Переместить {C:attention}#1#{} выбранн#<ую,ых>1#",
					"{C:attention}карт#<а,ы>1#{}, или {C:attention}набор#<,а>1#{}",
			...
			c_cry_variable = {
				name = "://VARIABLE",
				text = {
					"Конвертировать {C:cry_code}#1#{} выбранных карт#<у,ы>1#",
		...
		["Content Set"] = {
			...
			set_cry_timer = {
				...
				text = {
					"Предметы с эффектами завязанными на {C:attention}таймерах",
				},
			},
			set_cry_voucher = {
				name = "Проч. Ваучеры",
		...
		Edition = {
			...
			e_cry_blur = {
				...
				text = {
					...
					"{C:green}#1# к #2#{} шанс",
					"перезапустить ещё {C:attention}#3#{} раз#<,а>3#",
				},
			},
			e_cry_double_sided = {
				name = "Двухсторонний",
				text = {
					...
					"{C:inactive}(Чистая сторона может быть",
					"{C:inactive}объединена с другой картой)",
				},
			},
			e_cry_glass = {
				name = "Хрупкий",
				...
				text = {
					...
					"{C:green}#1# к #2#{} шанс, что эта",
					"карта не {C:red}уничтожается",
					"при срабатывании",
					"{C:inactive}Неподкручиваемо{}",
				},
			},
			e_cry_glitched = {
				name = "Глючный",
			...
			e_cry_m = {
				...
				text = {
					"{C:mult}+#1#{} Множ.",
					"Эта карта чувствует",
					"себя довольно {C:attention}весёлой{}",
				},
			},
		...
		Enhanced = {
			m_cry_echo = {
				...
				text = {
					"{C:green}#2# к #3#{} шанс",
					"{C:attention}перезапустить{} #1#",
					"дополнительный раз#<,а>1# при подсчёте",
				},
			},
			m_cry_light = {
				name = "Световая Карта",
				text = {
					...
					"засчитанными картами, получите {X:mult,C:white}X#1#{} Множ. и",
		...
		Joker = {
			...
			j_cry_bonusjoker = {
				...
				text = {
					...
					"{C:attention}слоты для джокеров{} или {C:attention}расходников",
					"на {C:dark_edition}#3#{} когда засчитана",
			...
			j_cry_booster = {
				name = "Бустер Джокер",
				text = {
					"{C:attention}+#1#{} Слот под Бустерные наборы",
					"В магазине",
				},
			},
			j_cry_boredom = {
				...
				text = {
					...
					"{C:inactive,s:0.8}Не влияет на другие Скуки{}",
				},
				unlock = {
					"Быть АФК на экране",
					"заставки в течение",
			...
			j_cry_busdriver = {
				...
				text = {
					...
					"{C:green}#4# к #3#{} шанс на {C:mult}-#2#{} Множ.",
				},
			},
			j_cry_canvas = {
				name = "Холст",
			...
			j_cry_chad = {
				...
				text = {
					...
					"{C:attention}#1#{} дополнительн#<ых,ый>1# раз#<,а>1#",
				},
			},
			j_cry_chili_pepper = {
				name = "Перец чили",
			...
			j_cry_circus = {
				...
				unlock = {
					"Заполучите {C:red}Редкого{},",
					"{C:cry_epic}Эпического{} и {C:legendary}Легендарного{}",
					"Джокера до {C:attention}9 Анте",
				},
			},
			j_cry_CodeJoker = {
				name = "Код Джокер",
			...
			j_cry_exposed = {
				name = "Обезличенный",
				text = {
					"Перезапуск всех засчитанных карт {C:attention}без лица",
			...
			j_cry_mask = {
				name = "Маска",
				text = {
					"Перезапуск всех засчитанных {C:attention}лицевых{} карт",
					"{C:attention}#1#{} дополнительных раз",
			...
			j_cry_lebaron_james = {
				...
				text = {
					...
					"и срабатыванию {C:attention}эффектов{} в руке",
			...
			j_cry_clockwork = {
				...
				text = {
					...
					"Превращает первую сыгранную карту в стальную каждые {C:attention}#11#{} {C:inactive}(#3#){} рук",
			...
			j_cry_highfive = {
				name = "Дай пять",
				text = {
					"Если наивысшее {C:attention}засчитанное достоинство{}",
			...
			j_cry_sacrifice = {
				name = "Жертва",
				text = {
					"Создаёт {C:green}#3#{} Необычн#<ого,ых>3#{} Джокер#<а,ов>3#",
					"и #2# {C:attention}Весёлых Джокер#<а,ов>2#{} когда",
			...
			j_cry_sapling = {
				name = "Росток",
				text = {
					"После засчитывания {C:attention}#2#{} {C:inactive}[#1#]{} улучшенных",
					"карт, продайте эту карту, чтобы",
					"создать #4# {V:1}#3#{} {C:attention}Джокера{}",
				},
			},
			j_cry_soccer = {
				name = "Один за всех",
			...
			j_cry_duplicare = {
				...
				text = {
					...
					"когда {C:attention}Джокер{} или",
					"игральная карта засчитана",
			...
			j_cry_equilib = {
				...
				text = {
					...
					"Создаёт {C:attention}#1#{} {C:dark_edition}Негативн#<ых,ого>1#{} джокер#<ов,а>1#",
					"когда рука сыграна",
			...
			j_cry_happyhouse = {
				...
				text = {
					...
					"сыгранных {C:attention}#3#{} рук{}",
					"{C:inactive}(Сейчас #2#/#3#){}",
			...
			j_cry_kscope = {
				...
				unlock = {
					...
					"имея {C:attention}5{} или больше",
					"{C:attention}карт с Выпуском{} или",
			...
			j_cry_loopy = {
				...
				text = {
					...
					"{C:inactive}(Сейчас{}{C:attention:} #1#{}{C:inactive} перезапуск#<,ов>1#){}",
			...
			j_cry_maximized = {
				...
				unlock = {
					"Сыграйте {C:attention}Флеш-пять{}",
			...
			j_cry_notebook = {
				name = "Блокнот",
				text = {
					"{C:green} #1# к #2#{} шанс получить {C:dark_edition}+#6#{} слот",
			...
			j_cry_pot_of_jokes = {
				...
				text = {
					...
					"{C:inactive}(Макс. {}{C:attention}#3#{}{C:inactive} размер руки){}",
				},
				unlock = {
			...
			j_cry_redbloon = {
				name = "Красный шар",
				text = {
					"Получите {C:money}$#1#{} через {C:attention}#2#{} раунда",
					"{C:red,E:2}самоуничтожается{}",
				},
			},
			j_cry_rescribere = {
		...
		Tag = {
			...
			tag_cry_gambler = {
				name = "Тег игрока",
				text = { "{C:green}#1# к #2#{} шанс создать", "{C:cry_exotic,E:1}Усиленный тег" },
			},
			tag_cry_gourmand = {
				name = "Гурманский тег",
			...
			tag_cry_rework = {
				name = "Тег доработки",
				text = { "В магазине есть #3#", "{C:dark_edition}#1# {C:cry_code}#2#" },
			},
			tag_cry_schematic = {
			...
			tag_cry_clone = {
				...
				text = {
					"Товары в магазине стоят в {C:attention}X#1#{}",
		...
		Voucher = {
			...
			v_cry_fabric = {
				...
				text = { "{C:dark_edition}+#1#{} слот#<,а>1# для джокеров" },
				unlock = {
			...
			v_cry_dexterity = {
				name = "Ловкость",
				text = { "Навсегда", "получите {C:blue}+#1#{} рук#<и,у>1#", "каждый раунд" },
				unlock = {
			...
			v_cry_overstock_multi = {
				name = "Мультизапас",
				text = {
					"{C:attention}+#1#{} слот#<,а>1# карт,",
					"{C:attention}+#1#{} слот#<,а>1# паков",
					"и {C:attention}+#1#{} слот#<,а>1# ваучеров",
					"в магазине",
				},
				unlock = {
	...
	misc = {
		...
		dictionary = {
			...
			cry_baneful_warning = "При пропуске изгоняет крайнего правого Джокера",
			cry_blind_baneful_pack = "После раунда откройте Злобный набор шута",
			cry_tax_placeholder = "(X0.4 требование блайнда)",
			cry_joke_placeholder = "(кратное 8)",
			b_tag = "Тег",
			b_blind = "Блайнд",
			b_tarot_rate = "Частота Таро",
			b_planet_rate = "Частота Планет",
			k_unique = "Уникальный",
			b_unique_cards = "Уникальные карты",
			b_playing_cards = "Игральные карты",
			cry_code_enter_hand = "ВВЕДИТЕ НАЗВАНИЕ ПОКЕРНОЙ РУКИ",
			cry_code_with_suits = "УЧИТЫВАТЬ МАСТИ",
			cry_code_without_suits = "ИГНОРИРОВАТЬ МАСТИ",
			cry_code_suitless = "Рука не требует определённых мастей",
			cry_code_exit = "ВЫЙТИ",
			cry_code_antevoucher = "След. Босс-блайнд и Ваучер",
			cry_code_nextjokers = "След. Джокеры в магазине",
			cry_code_nextcards = "След. вытянутые карты",
			cry_balanced_q = "Сбалансировано...?",
			cry_demicolon = "Демитриггер!",
			...
			k_downgraded_ex = "Понижено!",
			cry_mus_alt_bg = "Фоновая музыка (от MathIsFun_)",
			k_planet_nibiru = "Ничто",
		...
		v_dictionary = {
			...
			cry_circus_generic = "{V:#1#}#2#{} Джокеров каждый даёт {X:mult,C:white} X#3# {} Множ.",
		},
