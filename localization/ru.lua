	...
	descriptions = {
		...
		Joker = {
			...
			j_cry_exponentia = {
				...
				text = {
					...
					"когда срабатывает {X:red,C:white} XМножитель{}",
			...
			j_cry_membershipcardtwo = {
				name = "Старый членский билет", --Could probably have a diff Name imo
				text = {
			...
			j_cry_multjoker = {
				...
				text = {
					...
					"{C:spectral}Cryptid{} карту при засчитывании",
					"{C:inactive}(Должно быть место)",
				},
			},
			j_cry_negative = {
			...
			j_cry_notebook = {
				name = "Блокнот",
				text = {
					"{C:green} #1# из #2#{} шанс получить {C:dark_edition}+1{} слот",
			...
			j_cry_redeo = {
				...
				text = {
					...
					"потрачено {C:money}$#2#{} {C:inactive}($#3#){}",
					"{s:0.8}Требования растут",
					"{C:attention,s:0.8}экспоненциально{s:0.8} за использование",
					"{C:money,s:0.8}Следующий порог: {s:1,c:money}$#4#",
				},
			},
			j_cry_rescribere = {
				name = "Рескрибере",
			...
			j_cry_sacrifice = {
				...
				text = {
					...
					"использована {C:spectral}Призрачная{} карта",
					"{C:red}Работает раз в раунд{}",
					"{C:inactive}#1#{}",
				},
			},
			...
			j_cry_Scalae = {
				name = "Скале",
				text = {
					"Растущие {C:attention}Джокеры{} растут",
					"как полином степени {C:attention}#1#{}",
					"степень растёт на {C:attention}#2#{}",
					"в конце раунда",
					"{C:inactive,s:0.8}({C:attention,s:0.8}Скале{C:inactive,s:0.8} исключён)",
				},
			},
			j_cry_scrabble = {
				name = "Фишка Скрэббла",
			...
			j_cry_smallestm = {
				name = "Кроха",
				text = {
					"Создаёт тег {C:cry_jolly}Двойной М",
					"если {C:attention}покерная рука{}",
					"это {C:attention}#1#{}",
					"{C:inactive,s:0.8}короче я просто маленький",
				},
			},
			j_cry_soccer = {
				...
				text = {
					...
					"{C:attention}+#1#{} слот бустерного пака",
					"{C:attention}+#1#{} размер руки",
			...
			j_cry_speculo = {
				...
				text = {
					...
					"в конце {C:attention}магазина",
					"{C:inactive,s:0.8}Не копирует других Спекуло{}",
				},
			},
			j_cry_stardust = {
				name = "Звездная пыль",
			...
			j_cry_translucent = {
				...
				text = {
					"Продайте эту карту, чтобы создать",
					"копию {C:attention}Банан Скоропортящийся{}",
					"случайного {C:attention}Джокера",
			...
			j_cry_weegaming = {
				name = "2D",
				text = {
					"Перезапустить каждую сыгранную {C:attention}2{}", --wee gaming
		...
		Sleeve = {
			...
			sleeve_cry_critical_sleeve = {
				...
				text = {
					"После каждой сыгранной руки,",
					"{C:green}1 из 4{} шанс для {X:dark_edition,C:white} ^2 {} Множ.",
					"{C:green}1 из 8{} шанс для {X:dark_edition,C:white} ^0.5 {} Множ.",
				},
			},
			sleeve_cry_encoded_sleeve = {
				name = "Закодированный рукав",
				text = {
					"Начинаете с {C:cry_code,T:j_cry_CodeJoker}Код Джокером{}",
					"и {C:cry_code,T:j_cry_copypaste}Копировать/Вставить{}",
					"Только {C:cry_code}Карты кода{} появляются в магазине",
				},
			},
			sleeve_cry_equilibrium_sleeve = {
				...
				text = {
					...
					"появления в магазинах,",
					"начинайте забег с",
					"{C:attention,T:v_overstock_plus}+2 слота магазина",
				},
			},
			sleeve_cry_infinite_sleeve = {
				name = "Безлимитный рукав",
				text = {
					"Вы можете выбирать {C:attention}любое",
					"количество карт",
			...
			sleeve_cry_redeemed_sleeve = {
				...
				text = {
					"Когда {C:attention}Ваучер{} куплен,",
					"получите {C:attention}все улучш. версии",
				},
			},
		...
		Spectral = {
			...
			c_cry_white_hole = {
				name = "Белая дыра",
				text = {
					"{C:attention}Удалить{} все уровни рук,",
					"повысить {C:legendary,E:1}наиболее сыгранную{} покерную руку",
		...
		Stake = {
			...
			stake_cry_diamond = {
				...
				colour = "Алмазная",
				text = {
					"Нужно пройти Анте {C:attention}10{} для победы",
				},
			},
			stake_cry_amber = {
			...
			stake_cry_platinum = {
				...
				colour = "Платиновая",
				text = {
					"Малые блайнды {C:attention}убраны",
				},
			},
			stake_cry_twilight = {
			...
			stake_cry_ember = {
				...
				colour = "Огненная",
				text = {
					"Все предметы не дают деньги при продаже",
				},
			},
			stake_cry_dawn = {
		...
		Tag = {
			...
			tag_cry_bundle = {
				name = "Пакетный тег",
				text = {
					"Создать {C:attention}Стандартный тег{}, {C:tarot}Тег очарования{},",
					"{C:attention}Тег шута{} и {C:planet} тег метеора",
				},
			},
			tag_cry_cat = {
				name = "Кошачий тег",
				text = { "Мяу.", "{C:inactive}Level {C:dark_edition}#1#" },
			},
			tag_cry_console = {
				name = "Консольный тег",
				text = {
					"Даёт бесплатный",
					"{C:cry_code}Программный пак",
				},
			},
			tag_cry_double_m = {
				name = "Тег двойного М",
		...
		Voucher = {
			v_cry_asteroglyph = {
				name = "Астероглиф",
				text = {
					"Установить Анте на {C:attention}#1#{}",
				},
			},
			v_cry_blankcanvas = {
				name = "Чистый холст",
			...
			v_cry_fabric = {
				...
				text = {
					"{C:dark_edition}+#1#{} слот(а) для джокеров",
				},
			},
			v_cry_massproduct = {
			...
			v_cry_tacclimator = {
				...
				text = {
					...
					"в {C:attention}X#1#{} чаще",
					"в магазине",
					"Все будущие {C:tarot}карты Таро",
					"карты {C:green}бесплатны",
				},
			},
			v_cry_tag_printer = {
		...
		Other = {
			...
			banana = {
				...
				text = {
					"{C:green}#1# из #2#{} шанс",
					"быть уничтоженным каждый раунд",
				},
			},
			cry_rigged = {
				name = "Подкручено",
			...
			food_jokers = {
				...
				text = {
					...
					"{s:0.8}Черепаховая фасоль, диетическая кола, попкорн, рамен,",
			...
			cry_perishable_booster = {
				...
				text = {
					"Все карты в паке",
					"являются {C:attention}Скоропортящимися",
				},
			},
			cry_rental_booster = {
				name = "Аренда",
			...
			cry_pinned_booster = {
				...
				text = {
					"Все карты в паке",
					"являются {C:attention}Закреплёнными",
				},
			},
			cry_banana_booster = {
				name = "Банан",
			...
			p_cry_empowered = {
				name = "Призрачный пак [Усиленный тег]",
				text = {
					"Выберите {C:attention}#1#{} из",
