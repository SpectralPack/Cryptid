...
return {
	descriptions = {
		...
		Blind = {
			...
			bl_cry_tax = {
				name = "Налог",
				text = { "Максимальные очки за руку", "#1# требований блайнда" },
			},
			bl_cry_tornado = {
		...
		Code = {
			...
			c_cry_exploit = {
				name = "://EXPLOIT",
				text = {
					"{C:cry_code}Выберите{} {C:cry_code}видимую{} покерную руку,",
		...
		Edition = {
			...
			e_cry_blur = {
				...
				text = {
					...
					"{C:green}#1# к #2#{} шанс",
					"перезапустить ещё {C:attention}#3#{C:inactive} раз#<,а>3#",
				},
			},
			e_cry_double_sided = {
				name = "Двухсторонний",
